#import "FLTImageCropperPlusPlugin.h"
#import <TOCropViewController/TOCropViewController.h>
#import <UIKit/UIKit.h>
#import <MobileCoreServices/MobileCoreServices.h>
#import <Photos/Photos.h>

@interface FLTImageCropperPlusPlugin() <TOCropViewControllerDelegate>
@end

@implementation FLTImageCropperPlusPlugin {
...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
    FlutterMethodChannel* channel = [FlutterMethodChannel
      methodChannelWithName:@"id.my.dwiky/flutter_image_cropper_plus"
            binaryMessenger:[registrar messenger]];
    UIViewController *viewController = [UIApplication sharedApplication].delegate.window.rootViewController;
    FLTImageCropperPlusPlugin* instance = [[FLTImageCropperPlusPlugin alloc] initWithViewController:viewController];
